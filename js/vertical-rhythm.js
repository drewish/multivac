...
function updateIt() {
  ...
  function _drewish_vertical_css($base_font_size_px, $line_height_px, $font_size_px) {
  ...
  $font_sizes.split(/[\s,]+/).forEach(function($font_size_px) {
    var $font_css = _drewish_vertical_css($base_font_size_px, $line_height_px, $font_size_px);
